...
`$env:EMBEDDER_BINARY = "$($envVars['EMBEDDER_BINARY'])"
`$env:EMBEDDER_GPU_BINARY = "$($envVars['EMBEDDER_GPU_BINARY'])"
`$env:EMBEDDER_CPU_BINARY = "$($envVars['EMBEDDER_CPU_BINARY'])"
`$env:EMBEDDER_MODEL = "$($envVars['EMBEDDER_MODEL'])"
`$env:EMBEDDER_GPU = "$($envVars['EMBEDDER_GPU'])"
Set-Location "$binDir"
& "$binPath"
"@
